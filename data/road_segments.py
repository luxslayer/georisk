road_segments = {
    ...
    40:[
        {
            ...
            "km_start": 20,
            "km_end": 82,
            "coord_start": (25.4572, -101.0634),  
            "coord_end":   (25.6963, -100.5792),
        },
    ],
    ...
    57: [
        {
            "cities":    ("queretaro", "san luis potosi"),
            "km_start":  0,
            "km_end":    200,
    ...
    85: [
        {
            "cities":    ("monterrey", "nuevo laredo"),
            "km_start":  20,
            "km_end":    200,
            "coord_start": (25.8513, -100.2434),
            "coord_end":   (27.2541,  -99.6232),
        },
    ],
